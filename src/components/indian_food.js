...
const Indianlist = ({all_indian}) => (
  <div>
  {all_indian.map(Indian => (
    <Singularsnack image={Indian.image} title={Indian.title} ingredients={Indian.ingredients} instructions={Indian.instructions}/>
  ))}
  </div>
);
...
class Indian extends Component {
  render() {
      ...
      <div className="w3-black marg">
            ...
            <Indianlist all_indian={all_indian}/>
      </div>
    );
  }
}
